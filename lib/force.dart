...
class Force extends StatefulWidget {
  const Force({Key? key}) : super(key: key);
...
class _ForceState extends State<Force> {
  @override
  var c = ["dyne", "Newton", "Kilogram-force"];
  Map<String, int> m = {
    "dyne": 0,
    "Newton": 1,
    "Kilogram-force": 2,
  };
  String dropdownValue = "dyne";
  String dropdownValue1 = "Kilogram-force";
  double Result = 0;
  final myController = TextEditingController();
  dynamic f = {
    "0": [1, 0.00001, 0.0000010197],
    "1": [100000, 1, 0.1019716],
    "2": [980665, 9.80665, 1]
  };
  void convert() {
