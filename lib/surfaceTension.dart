...
class SurfaceTension extends StatefulWidget {
  const SurfaceTension({Key? key}) : super(key: key);

  @override
  State<SurfaceTension> createState() => _SurfaceTensionState();
}

class _SurfaceTensionState extends State<SurfaceTension> {
  @override
  var c = [
    "Newton/meter",
  ...
  Map<String, int> m = {
    "Newton/meter": 0,
    "Gram-force/centimeter": 1,
    "dyne/centimeter": 2,
    "erg/square centimeter": 3
  };
  String dropdownValue = "Newton/meter";
  String dropdownValue1 = "Gram-force/centimeter";
  double Result = 0;
  final myController = TextEditingController();
  dynamic f = {
    "0": [1, 1.020, 1000, 1000],
    "1": [0.981, 1, 980.665, 980.665],
    "2": [0.001, 0.001, 1, 1],
    "3": [0.001, 0.001, 1, 1]
  };
  void convert() {
